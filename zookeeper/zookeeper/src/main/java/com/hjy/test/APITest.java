...
public class APITest {
    private static final String connectString = "119.3.165.213:2182";
    ...
    public  void testCreate(String[] args) throws Exception{
        ...
        String node = zkClient.create("/idea", "hellozk".getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
...
//        Thread.sleep(Long.MAX_VALUE);//真正运行时可以注释
    ...
    public void getData() throws Exception{
        byte[] data = zkClient.getData("/PARENT_NODE/test1",false, null);
